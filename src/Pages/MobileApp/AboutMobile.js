...
import styles from '../../CSS/Mobile/AboutMobile.module.css'
import image1 from '../../Images/aboutMobile.png'
                ...
                <Row>
                    ...
                    <Col xs={12} sm={12} md={6}>
                        <div className={styles.aboutHeader}>
                            We Make Custom <span className={styles.color}>Mobile App Design</span>
                        </div>
